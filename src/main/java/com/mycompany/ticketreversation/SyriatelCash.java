 ...
 * @author dell
 */
public class SyriatelCash extends javax.swing.JFrame {

    /**
     * Creates new form SyriatelCash
     */
    public SyriatelCash() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Syriatel Cash");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setPreferredSize(new java.awt.Dimension(768, 410));
        jPanel1.setLayout(null);

        jLabel2.setIcon(new javax.swing.ImageIcon("Photos\\Syriatel_Logo.png")); // NOI18N
        jPanel1.add(jLabel2);
        jLabel2.setBounds(270, 10, 230, 170);
...
//زر الدفع
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SyriatelCash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SyriatelCash().setVisible(true);
            }
        });
    }
